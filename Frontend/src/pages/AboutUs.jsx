...
const AboutUs = () => {
  return (
    <div className="relative h-[90vh] py-16 px-4 lg:px-24 overflow-hidden flex items-center justify-center text-white">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <motion.h1
          className="text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-[#00e0ff] to-[#8e44ad] bg-clip-text text-transparent mb-6"
        ...
        >
          At <span className="font-semibold text-[#00e0ff]">Berozgar.com</span>,
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10 text-left">
          {/* Mission Card */}
          <motion.div
            className="bg-[#1a1a1a] rounded-xl shadow-lg border border-[#2f2f2f] p-6 hover:shadow-xl transition backdrop-blur-md"
            initial={{ y: 40, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.5 }}
          >
            <h2 className="text-2xl font-semibold text-[#00e0ff] mb-2">
              Our Mission
            </h2>
